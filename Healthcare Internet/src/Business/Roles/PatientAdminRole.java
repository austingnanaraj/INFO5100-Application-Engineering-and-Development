...
import UserInterface.PatientAdminRole.PatientManagerWorkAreaJPanel;
...
public class PatientAdminRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem ecoSystem,Network net) {
        return new PatientManagerWorkAreaJPanel(userProcessContainer, (PatientAdminOrganization) organization, enterprise, account, ecoSystem);
    }
