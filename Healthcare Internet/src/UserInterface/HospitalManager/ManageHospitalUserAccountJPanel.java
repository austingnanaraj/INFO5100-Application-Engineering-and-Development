...
public class ManageHospitalUserAccountJPanel extends javax.swing.JPanel {
    ...
    public void popOrganizationComboBox() {
        ...
        for (Organization org : enterprise.getOrganizationDirectory().getOrganizationDirectory()) {
            if (org instanceof NurseOrganization || org instanceof DoctorOrganization) {
                organizationJComboBox.addItem(org);
            }
        }
    }

    public void populateDoctorComboBox(Organization organization) {
        DoctorJComboBox.removeAllItems();
        if (organization instanceof DoctorOrganization) {
            for (Doctor doctor : ((HospitalEnterprise) enterprise).getDoctorDirectory().getDoctorDirectory()) {
                DoctorJComboBox.addItem(doctor);
            }
        } else {
            if (organization instanceof NurseOrganization) {
                for (Nurse nurse : ((HospitalEnterprise) enterprise).getNurseDirectory().getNurseDirectory()) {
                    DoctorJComboBox.addItem(nurse);
                }
            }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(DoctorJComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        Person person = (Person) DoctorJComboBox.getSelectedItem();
