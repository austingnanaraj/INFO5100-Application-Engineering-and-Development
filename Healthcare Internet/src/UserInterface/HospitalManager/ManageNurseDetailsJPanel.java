...
import UserInterface.Hospital.Nurse.AddNurseJPanel;
 ...
 */
public class ManageNurseDetailsJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageNurseDetailsJPanel(JPanel userProcessContainer, Enterprise enterprise, Organization organization, UserAccount userAccount) {
        initComponents();
    ...
    public void populatetable() {
        DefaultTableModel dtm = (DefaultTableModel) viewNurseDetailsJTable.getModel();
        dtm.setRowCount(0);

        for (Nurse d : ((HospitalEnterprise) enterprise).getNurseDirectory().getNurseDirectory()) {
    ...
    private void initComponents() {
        ...
        viewNurseDetailsJTable = new javax.swing.JTable();
        ...
        viewNurseDetailsJTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Nurse Name", "SSN", "Contact Number", "Address", "Department name"
            }
        ) {
        ...
        jScrollPane1.setViewportView(viewNurseDetailsJTable);
        if (viewNurseDetailsJTable.getColumnModel().getColumnCount() > 0) {
            viewNurseDetailsJTable.getColumnModel().getColumn(0).setResizable(false);
            viewNurseDetailsJTable.getColumnModel().getColumn(1).setResizable(false);
            viewNurseDetailsJTable.getColumnModel().getColumn(2).setResizable(false);
            viewNurseDetailsJTable.getColumnModel().getColumn(3).setResizable(false);
            viewNurseDetailsJTable.getColumnModel().getColumn(4).setResizable(false);
        }
        ...
        searchJButton.setText("Search Nurse");
        ...
        deleteJButton.setText("Delete Nurse");
    ...
    private void deleteJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteJButtonActionPerformed
        // TODO add your handling code here:
        int selectedRow = viewNurseDetailsJTable.getSelectedRow();
        if (selectedRow >= 0) {
            Nurse d = (Nurse) viewNurseDetailsJTable.getValueAt(selectedRow, 0);
            int dialogButton = JOptionPane.YES_NO_OPTION;
            int dialogResult = JOptionPane.showConfirmDialog(null, "Would you like to delete", "warning", dialogButton);
            if (dialogResult == JOptionPane.YES_OPTION) {
                ((HospitalEnterprise) enterprise).getNurseDirectory().removeNurse(d);
    ...
    private void addDoctorJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addDoctorJButtonActionPerformed
        // TODO add your handling code here:
        AddNurseJPanel adoc = new AddNurseJPanel(userProcessContainer, enterprise, organization);
    ...
    private javax.swing.JTable viewNurseDetailsJTable;
