 ...
 */
public class ManageDrugManufacturerOrganizationJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageDrugManufacturerOrganizationJPanel(JPanel userProcessContainer, OrganizationDirectory directory) {
        initComponents();
    ...
    private void populateCombo() {
        ...
        for (Type type : Organization.Type.values()) {
            if (type.getValue().equals(Type.DrugManufacturer.getValue())
                    ) {
