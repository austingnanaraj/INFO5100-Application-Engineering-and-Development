...
public class ManagePatientDetailsJPanel extends javax.swing.JPanel {
   ...
   private Enterprise enterprise;
     ...
     */
    public ManagePatientDetailsJPanel(JPanel userProcessContainer,Enterprise enterprise,Organization organization) {
        initComponents();
...
//            row[4] = d.getDepartment();
    ...
    private void initComponents() {
        ...
        deleteJButton.setText("Delete Patient >>");
        deleteJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deleteJButtonActionPerformed(evt);
            }
        });
        add(deleteJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 360, 140, 30));
        ...
        add(addPatientJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 340, -1, -1));
        ...
        add(refreshJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 260, -1, -1));
...
// if we don't find the result 
    ...
    private void deleteJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteJButtonActionPerformed
        ...
        if (selectedRow >= 0) {
            Patient p = (Patient) viewPatientDetailsJTable.getValueAt(selectedRow, 0);
            int dialogButton = JOptionPane.YES_NO_OPTION;
            int dialogResult = JOptionPane.showConfirmDialog(null, "Would you like to delete", "warning", dialogButton);
            if (dialogResult == JOptionPane.YES_OPTION) {
               ((HospitalEnterprise)enterprise).getPatientDirectory().deletePatient(p);
