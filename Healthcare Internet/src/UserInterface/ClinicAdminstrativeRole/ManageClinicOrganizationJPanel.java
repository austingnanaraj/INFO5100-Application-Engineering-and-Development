...
public class ManageClinicOrganizationJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageClinicOrganizationJPanel(JPanel userProcessContainer, OrganizationDirectory directory) {
        initComponents();
    ...
    private void populateCombo() {
        ...
        for (Type type : Organization.Type.values()) {
            if (type.getValue().equals(Type.HospitalMangaement.getValue())
                    || type.getValue().equals(Type.patientManagerAdmin.getValue())
                    || type.getValue().equals(Type.DoctorOrganization.getValue()) || type.getValue().equals(Type.patient.getValue())) {
